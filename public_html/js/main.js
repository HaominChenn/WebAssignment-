...
var i = 1;
function load() {
    document.getElementById("question").innerHTML = "(" + (questionIndex + 1) + "). " + questions[questionIndex].question;
...
function answerButton() {
    ...
    if (questions[questionIndex].answer == answer - 1) {
        ...
        document.getElementById("answer").innerHTML = "Your Guess is incorrect! Better luck next time!"
